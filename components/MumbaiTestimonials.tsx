        ...
        <div className="mt-3 grid min-h-0 flex-1 items-center gap-5 md:mt-5 md:grid-cols-[minmax(190px,0.7fr)_1.3fr] md:gap-10 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="flex min-h-0 flex-col justify-center">
            ...
            <article className="mt-3 md:mt-4" aria-live="polite" aria-atomic="true">
              ...
              <div className="mt-3 border-t border-white/15 pt-3 md:mt-4">
                <p className="font-display text-base font-semibold sm:text-lg">{testimonial.author}</p>
                {testimonial.organisation && (
                  <p className="mt-0.5 text-xs font-semibold text-white/65 sm:text-sm">{testimonial.organisation}</p>
                )}
              </div>
            </article>
