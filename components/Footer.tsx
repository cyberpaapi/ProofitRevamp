...
const socials = [
  { label: "Instagram", href: "https://www.instagram.com/proofitcompany?igsh=MWFzbzEyanE2eXB0OA==", d: "M8 0C5.8 0 5.6 0 4.7.1 3.9.1 3.3.3 2.8.5c-.6.2-1 .5-1.5 1S.7 2.3.5 2.8C.3 3.3.1 3.9.1 4.7 0 5.6 0 5.8 0 8s0 2.4.1 3.3c0 .8.2 1.4.4 1.9.2.5.5 1 1 1.5s.9.7 1.4 1c.5.2 1 .3 1.9.4.9 0 1.1.1 3.3.1s2.4 0 3.3-.1c.8 0 1.4-.2 1.9-.4a4 4 0 0 0 2.4-2.4c.2-.5.3-1 .4-1.9V8c0-2.2 0-2.4-.1-3.3 0-.8-.2-1.4-.4-1.9a4 4 0 0 0-2.4-2.4C12.7.3 12.1.1 11.3.1 10.4 0 10.2 0 8 0zm0 1.4c2.1 0 2.4 0 3.2.1.8 0 1.2.2 1.5.3.4.1.7.3.9.6.3.3.5.6.6 1 .1.2.3.6.3 1.4.1.8.1 1.1.1 3.2s0 2.4-.1 3.2c0 .8-.2 1.2-.3 1.5-.1.4-.3.7-.6.9-.3.3-.6.5-.9.6-.3.1-.7.3-1.5.3-.8.1-1.1.1-3.2.1s-2.4 0-3.2-.1c-.8 0-1.2-.2-1.5-.3a2.6 2.6 0 0 1-1-.6 2.6 2.6 0 0 1-.5-.9c-.1-.3-.3-.7-.3-1.5C1.4 10.4 1.4 10.1 1.4 8s0-2.4.1-3.2c0-.8.2-1.2.3-1.5.1-.4.3-.7.6-.9.3-.3.5-.5.9-.6.3-.1.7-.3 1.5-.3.8-.1 1.1-.1 3.2-.1zM8 3.9a4.1 4.1 0 1 0 0 8.2 4.1 4.1 0 0 0 0-8.2zm0 6.8a2.7 2.7 0 1 1 0-5.4 2.7 2.7 0 0 1 0 5.4zm5.2-7a1 1 0 1 1-1.9 0 1 1 0 0 1 1.9 0z" },
  { label: "Threads", href: "https://www.threads.com/@proofitcompany", d: "M8.1 1.4c-3.7 0-6 2.4-6 6.5 0 4.2 2.3 6.7 6.1 6.7 3.2 0 5.4-1.8 5.7-4.5.2-2.1-.7-3.8-2.5-4.7C10.5 5.8 9.4 5.5 8 5.5c-2.3 0-3.8 1.2-3.8 3 0 1.7 1.4 2.9 3.4 2.9 2.2 0 3.7-1.3 3.8-3.4.8.5 1.2 1.3 1.1 2.2-.2 1.9-1.8 3-4.2 3-3 0-4.7-1.9-4.7-5.3 0-3.3 1.7-5.1 4.6-5.1 2 0 3.4.8 4.2 2.4l1.3-.7C12.6 2.4 10.7 1.4 8.1 1.4zm-.4 8.7c-1.2 0-2-.6-2-1.6s.8-1.6 2.2-1.6c.8 0 1.6.2 2.1.5 0 1.7-.9 2.7-2.3 2.7z" },
  { label: "LinkedIn", href: "https://www.linkedin.com/company/proofit-company/?lipi=urn%3Ali%3Apage%3Ad_flagship3_company_admin_dashboard_index%3B5Jp56m9PRuKpWdnnD6bCCg%3D%3D", d: "M0 1.1C0 .5.5 0 1.2 0h13.6c.7 0 1.2.5 1.2 1.1v13.8c0 .6-.5 1.1-1.2 1.1H1.2C.5 16 0 15.5 0 14.9V1.1zm4.9 12.3V6.2H2.5v7.2h2.4zM3.7 5.2c.9 0 1.4-.5 1.4-1.2 0-.7-.5-1.2-1.3-1.2-.9 0-1.4.5-1.4 1.2 0 .7.5 1.2 1.3 1.2zm5 8.2V9.4c0-.2 0-.4.1-.6.2-.4.5-.9 1.2-.9.9 0 1.2.6 1.2 1.6v3.9h2.4V9.2c0-2.2-1.2-3.2-2.7-3.2-1.3 0-1.8.7-2.1 1.2v-1H6.3v7.2h2.4z" },
  { label: "Facebook", href: "https://www.facebook.com/share/1BwiDkEiUf/?mibextid=wwXIfr", d: "M16 8a8 8 0 1 0-9.2 7.9v-5.6h-2V8h2V6.3c0-2 1.2-3.1 3-3.1.9 0 1.8.1 1.8.1v2h-1c-1 0-1.3.6-1.3 1.2V8h2.2l-.4 2.3H9.2v5.6A8 8 0 0 0 16 8z" },
  { label: "YouTube", href: "https://youtube.com/@proofitcompany?si=m-CXctVEqPC9lUnG", d: "M15.7 4.2a2 2 0 0 0-1.4-1.4C13 2.4 8 2.4 8 2.4s-5 0-6.3.3A2 2 0 0 0 .3 4.2C0 5.4 0 8 0 8s0 2.6.3 3.8a2 2 0 0 0 1.4 1.4c1.2.4 6.3.4 6.3.4s5 0 6.3-.3a2 2 0 0 0 1.4-1.4C16 10.6 16 8 16 8s0-2.6-.3-3.8zM6.4 10.4V5.6L10.6 8l-4.2 2.4z" },
          ...
          <div className="flex flex-wrap justify-center gap-2.5 md:justify-end">
            {socials.map((s) => (
              <a
                ...
                className="flex h-11 w-11 items-center justify-center rounded-full border border-white/15 text-white/70 transition-[transform,border-color,color,background-color] duration-300 hover:-translate-y-0.5 hover:border-brand hover:bg-brand hover:text-white active:translate-y-0 active:scale-[0.96] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-brand"
              >
